...
/**
* check_elf - looks if the file is an ELF file.
* @e_ident: points to the array containing the ELF magic num.
*
...
/**
* print_magic - magic num of an ELF header is being printed.
* @e_ident: points to an array containing the ELF magic num.
*
* Description: Magic numb are separated by a spaces or whitespace.
*/
...
/**
* print_class -  the class of an ELF header is been printed.
