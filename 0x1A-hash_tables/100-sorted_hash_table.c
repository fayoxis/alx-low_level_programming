 ...
 * @ht: the Pointer point to the sorted hash table to be printed.
 *
 ...
 * @ht: A pointer that points to the hash table to be printed.
 ...
 * @ht: it is a pointer that points to hash table to be deleted.
 *
